...
create_clock -name {CLK1} -period 20.000 -waveform { 0.000 10.000 } [get_ports {CLOCK}]
...
set_clock_uncertainty -rise_from [get_clocks {CLK1}] -rise_to [get_clocks {CLK1}] -setup 0.280  
set_clock_uncertainty -rise_from [get_clocks {CLK1}] -rise_to [get_clocks {CLK1}] -hold 0.270  
set_clock_uncertainty -rise_from [get_clocks {CLK1}] -fall_to [get_clocks {CLK1}] -setup 0.280  
set_clock_uncertainty -rise_from [get_clocks {CLK1}] -fall_to [get_clocks {CLK1}] -hold 0.270  
set_clock_uncertainty -fall_from [get_clocks {CLK1}] -rise_to [get_clocks {CLK1}] -setup 0.280  
set_clock_uncertainty -fall_from [get_clocks {CLK1}] -rise_to [get_clocks {CLK1}] -hold 0.270  
set_clock_uncertainty -fall_from [get_clocks {CLK1}] -fall_to [get_clocks {CLK1}] -setup 0.280  
set_clock_uncertainty -fall_from [get_clocks {CLK1}] -fall_to [get_clocks {CLK1}] -hold 0.270  
